...
class Box(object):
    ...
    def double(self):
        ...
        didnt_fit = self.append_string(self.contents)
        return didnt_fit
    ...
    def double_then_shrink(self, new_volume):
        ...
        # count = len(self.double() + len(self.shrink(new_volume)))
        # return count
    ...
    def reset(self):
        ...
        self.content_history.append(self.contents)
    ...
    def steal(self, other_box):
        ...
        left_over = self.append_string(other_box.contents)
        other_box.contents = left_over
    ...
    def combined_box(self, other_box):
        ...
        x = self.contents + other_box.contents
        y = self.volume + other_box.volume
